...
UniswapV3 + Permit2 **deployer address **: **0xE49c9ea00337182374E112C452247A2D1db61798**

UnsupportedProtocol + UniversalRouter : **0x6dDE76BD012Af35d7d2e2F6E23700Cc101DDead0**

**UniversalRouter **deployer **address **: **0x6dDE76BD012Af35d7d2e2F6E23700Cc101DDead0**
...
"Unsupproted" :"0x59c603458F8d3C5079a0D78eb1BA28A9FAe0a759"
```
...
poolAddressWETHUSDT: 0x83f0F8BbBC38246824F9aCe988c48f9bA06eCd4E fee: 100 (no liquidity)
poolAddressWETHUSDC : 0xf14Bdf5F0Da500a3a1e2b19b3AED9b92778A782C fee: 100
```
...
======createAndInitialize poolAddressWETHUSDT======= 0.01% (no liquidity)
transactionHash: 0x3e26e1f4271c13903c764cd0e9a1581bd9366ecbb6d85325bbc5b9244d4b9691
gasUsed:  BigNumber { value: "4570013" }

======createAndInitialize poolAddressWETHUSDC======= 0.01%
transactionHash: 0x4e67998b87eb7be35ffbd170a1c80ea4cbd17565b6b2e3e50cbc2a366b75aa08
gasUsed:  BigNumber { value: "4570030" }
```
...
transactionHash: 0x7ce1c532f77acbad7132681a032799e92f716d4449065f99818b53d8ff4466f3
gasUsed:  BigNumber { value: "491325" }
eventName: IncreaseLiquidity
[
  BigNumber { value: "12" },
  BigNumber { value: "294931249651652352284" },
  BigNumber { value: "497850203585755411" },
  BigNumber { value: "2499999999999999999993" },
  tokenId: BigNumber { value: "12" },
  liquidity: BigNumber { value: "294931249651652352284" },
  amount0: BigNumber { value: "497850203585755411" },
  amount1: BigNumber { value: "2499999999999999999993" }
]
//완료
...
transactionHash: 0x2b170dcf0f412264c93ac1fa79176d51d3b1c6a7a3b44218dc6fd103381dfaa2
gasUsed:  BigNumber { value: "445696" }
eventName: IncreaseLiquidity
[
  BigNumber { value: "14" },
  BigNumber { value: "363087391369289655328" },
  BigNumber { value: "500000000000000000" },
  BigNumber { value: "2468951128434362880007" },
  tokenId: BigNumber { value: "14" },
  liquidity: BigNumber { value: "363087391369289655328" },
  amount0: BigNumber { value: "500000000000000000" },
  amount1: BigNumber { value: "2468951128434362880007" }
]
//완료


====== poolAddressWETHUSDC mint ==========
transactionHash: 0x1a467ee8cab1f5a2a002ddd743ff0cc6dff3606d0d0fd982a44bbf4347fa3fda
gasUsed:  BigNumber { value: "508297" }
eventName: IncreaseLiquidity
[
  BigNumber { value: "16" },
  BigNumber { value: "482100733649717" },
  BigNumber { value: "499999999999999499" },
  BigNumber { value: "4903923253" },
  tokenId: BigNumber { value: "16" },
  liquidity: BigNumber { value: "482100733649717" },
  amount0: BigNumber { value: "499999999999999499" },
  amount1: BigNumber { value: "4903923253" }
]
//완료
...
transactionHash: 0xa50b93ae6a7cf44f8b2bd5cf3b3624f57a34bbc573fdcac2e477f8a23a4d263e
gasUsed:  BigNumber { value: "491864" }
eventName: IncreaseLiquidity
[
  BigNumber { value: "17" },
  BigNumber { value: "5185743638043" },
  BigNumber { value: "99958792251230230" },
  BigNumber { value: "49999999" },
  tokenId: BigNumber { value: "17" },
  liquidity: BigNumber { value: "5185743638043" },
  amount0: BigNumber { value: "99958792251230230" },
  amount1: BigNumber { value: "49999999" }
]

====== poolAddressWETHUSDC100 mint ==========
transactionHash: 0x8583846bbd07dfae58099fedc94f3e9b925fb9139f010138034d5552bcb404c8
gasUsed:  BigNumber { value: "505539" }
eventName: IncreaseLiquidity
[
  BigNumber { value: "20" },
  BigNumber { value: "510716390292922" },
  BigNumber { value: "499857369193148189" },
  BigNumber { value: "5000000000" },
  tokenId: BigNumber { value: "20" },
  liquidity: BigNumber { value: "510716390292922" },
  amount0: BigNumber { value: "499857369193148189" },
  amount1: BigNumber { value: "5000000000" }
]
```
...
- [https://goerli.explorer.tokamak.network/tx/0x899a6050fbe254792af470cb64cff7e798f7d230617363a0ddace6c0b49b02c1/logs](https://goerli.explorer.tokamak.network/tx/0x899a6050fbe254792af470cb64cff7e798f7d230617363a0ddace6c0b49b02c1/logs)
- github, 