...
-  Project ECO's final goals are twofold:
  1. Complete and oversee the launch of the new Tokamak Network landing page
...
- **A1.** Propose DAO agenda for staking contract upgrade
- **A2.** Launch Staking V2.5 testnet
- **A3.** Launch Simple Staking V2.5 with DAO candidate and L2 support
- **A4.** Launch **community version v1.0 + community guide** with Simple Staking V2.5 support
- **A5.** Release TON staking SDK v1.0 with Simple Staking V2.5 support
- **A6.** Discontinue Simple Staking V2.5
- **A7.** Release slashing protocol (in collaboration with TOP + TRH team)
- **A8.** Host first hackathon featuring TON staking SDK with prize pool
- **A9.** Host a public seminar/workshop on slashing
- **A10.** Publish peer-reviewed article on slashing
- **A11.** **Release TON staking SDK v2.0** with slashing support
- **A12.** Launch **community version v2.0 + community guide** with slashing support
- **A13.** **Release fast withdrawal protocol for staked TON**
- **A14.** **Release TON staking SDK v3.0** with fast withdrawal support for staked TON
- **A15.** **Launch** **community version v3.0 + community guide** with fast withdrawal support for staked TON
- **A16.** Host second hackathon featuring TON staking SDK with prize pool

### B. Tokamak DAO V2 

- B1. Implement DAO v2 on Sepolia
- B2. **Publish DAO V2.0 policy document**: Include Snapshot and Discord information
- B3. **Open community version v1.0 + community guide**: Include documentation for new agenda creation via Snapshot and forum
- B4. Shut down DAO frontend and backend
- B5. **Open community version v2.0**: Add support for arbitrary code execution through Tally interface
- B6. **Publish DAO V2.1 policy document**: Include security council policies
- B7. **Publish DAO v2.1 protocol + community guide**: Remove EOA from DAOCommittee Proxy, implement security council, enhance contract security, and define security council roles
- B8. **Open community version v3.0**: Remove EOA from DAOCommittee Proxy, implement security council, enhance contract security, and define security council roles
- B9. **Publish Tokamak Network DAO L2 support + community guide**

### C. Tokamak Network Landing page

- C1. Open a new landing page 
- C2. Open sub-landing page for Protocols 
- C3. Shutdown price dashboard 
- C4. Open price API v2.0: optimize current price API without affecting widely used functions  

## ii. Timeline

| Year | Quarter | Milestone output | Outputs | etc |
| --- | --- | --- | --- | --- |
| Up until 2024 | Q4 | A1, B1, C1 | 1 agenda, 2 service |  |
| 2025 | Q1 | A2, A3, A4, A5, A6, B2, C2, C3 | 3 service, 1 sdk, 1 document, 1 guide, 1 service update | Simple staking & price dashboard shut down |
|  | Q2 | B3, B4, B5, C4 | 2 service update, 1 guide  | Shutdown DAO |
|  | Q3 | A7, A8, A9, A10, A11, A12, B6 | 1 protocol, 1 hackathon, 1 seminar, 1 article, 2 service update, 1 document |  |
|  | Q4 | B7, B8 | 1 document, 1 service update, 1 guide |  |
| 2026 | Q1 | A13, A14, A15, A16, B9 | 2 service update, 1 protocol, 2 guide, 1 hackathon |  |
