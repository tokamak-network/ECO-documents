***—> plasma-evm-contracts는 현재 사용되지 않지만, 특정 애플리케이션을 Layer2로 등록할 수 있도록 이 함수를 남겨두었다.***

> *operatorCheck 함수는 candidate 주소가 올바른지 확인을 위해 호출한다. 유효한 candidate 주소로 실제 privateLayer2의 존재 여부를 확인할 수 있다. 현재 Tokamak Network의 *[*모든 candidate*](https://github.com/tokamak-network/ton-staking-v2/blob/ton-staking-v2/docs/deployed-addresses-mainnet.md#layer-addresses)*는 privateLayer2가 아니다.*
